...
public class CreateGroupChannelActivity extends AppCompatActivity
    implements SelectUserFragment.UsersSelectedListener,
    SelectDistinctFragment.DistinctSelectedListener {
  ...
  @Override public void onUserSelected(boolean selected, String userId) {
    if (selected) {
  ...
  @Override public void onDistinctSelected(boolean distinct) {
  ...
  @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    if (savedInstanceState == null) {
      ...
      manager.beginTransaction().replace(R.id.container_create_group_channel, fragment).commit();
    }
