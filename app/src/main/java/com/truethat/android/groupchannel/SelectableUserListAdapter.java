...
import com.truethat.android.main.BlockedMembersListActivity;
...
public class SelectableUserListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public void unblock() {
    for (final String userId : mSelectedUserIds) {
      SendBird.unblockUserWithUserId(userId, new SendBird.UserUnblockHandler() {
        @Override public void onUnblocked(SendBirdException e) {
          if (e != null) {
            return;
          }
  ...
  @Override public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    View view = LayoutInflater.from(parent.getContext())
        .inflate(R.layout.list_item_selectable_user, parent, false);
  ...
  @Override public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
    ((SelectableUserHolder) holder).bind(mContext, mUsers.get(position),
        isSelected(mUsers.get(position)), mCheckedChangeListener);
  }
  ...
  private class SelectableUserHolder extends RecyclerView.ViewHolder {
    ...
    private void bind(final Context context, final User user, boolean isSelected,
