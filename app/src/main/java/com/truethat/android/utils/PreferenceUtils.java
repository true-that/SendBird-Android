package com.truethat.android.utils;
...
public class PreferenceUtils {
  ...
  public static final String PREFERENCE_KEY_NOTIFICATIONS_SHOW_PREVIEWS =
      "notificationsShowPreviews";
  public static final String PREFERENCE_KEY_NOTIFICATIONS_DO_NOT_DISTURB =
      "notificationsDoNotDisturb";
  public static final String PREFERENCE_KEY_NOTIFICATIONS_DO_NOT_DISTURB_FROM =
      "notificationsDoNotDisturbFrom";
  public static final String PREFERENCE_KEY_NOTIFICATIONS_DO_NOT_DISTURB_TO =
  ...
  public static void setNotificationsShowPreviews(Context context,
      boolean notificationsShowPreviews) {
    SharedPreferences.Editor editor = getSharedPreferences(context).edit();
  ...
  public static boolean getNotificationsShowPreviews(Context context) {
    return getSharedPreferences(context).getBoolean(PREFERENCE_KEY_NOTIFICATIONS_SHOW_PREVIEWS,
        true);
  }

  public static void setNotificationsDoNotDisturb(Context context,
      boolean notificationsDoNotDisturb) {
    SharedPreferences.Editor editor = getSharedPreferences(context).edit();
    editor.putBoolean(PREFERENCE_KEY_NOTIFICATIONS_DO_NOT_DISTURB, notificationsDoNotDisturb)
        .apply();
  }

  public static boolean getNotificationsDoNotDisturb(Context context) {
    return getSharedPreferences(context).getBoolean(PREFERENCE_KEY_NOTIFICATIONS_DO_NOT_DISTURB,
        false);
  }

  public static void setNotificationsDoNotDisturbFrom(Context context,
      String notificationsDoNotDisturbFrom) {
    SharedPreferences.Editor editor = getSharedPreferences(context).edit();
    editor.putString(PREFERENCE_KEY_NOTIFICATIONS_DO_NOT_DISTURB_FROM,
        notificationsDoNotDisturbFrom).apply();
  }
  ...
  public static void setNotificationsDoNotDisturbTo(Context context,
      String notificationsDoNotDisturbTo) {
    SharedPreferences.Editor editor = getSharedPreferences(context).edit();
    editor.putString(PREFERENCE_KEY_NOTIFICATIONS_DO_NOT_DISTURB_TO, notificationsDoNotDisturbTo)
        .apply();
  }
