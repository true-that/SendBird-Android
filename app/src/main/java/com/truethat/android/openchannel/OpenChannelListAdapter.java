...
class OpenChannelListAdapter extends RecyclerView.Adapter<OpenChannelListAdapter.ChannelHolder> {
  ...
  @Override public ChannelHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    View view = LayoutInflater.from(parent.getContext())
        .inflate(R.layout.list_item_open_channel, parent, false);
    return new ChannelHolder(view);
  }

  @Override public void onBindViewHolder(ChannelHolder holder, int position) {
    holder.bind(mContext, mChannelList.get(position), position, mItemClickListener,
  ...
  static class ChannelHolder extends RecyclerView.ViewHolder {
    ...
    private String[] colorList =
        { "#ff2de3e1", "#ff35a3fb", "#ff805aff", "#ffcf47fb", "#ffe248c3" };

    ChannelHolder(View itemView) {
      super(itemView);
      nameText = (TextView) itemView.findViewById(R.id.text_open_channel_list_name);
      participantCountText =
          (TextView) itemView.findViewById(R.id.text_open_channel_list_participant_count);
    ...
    void bind(final Context context, final OpenChannel channel, int position,
      ...
      String participantCount = String.format(
          context.getResources().getString(R.string.open_channel_list_participant_count),
          channel.getParticipantCount());
